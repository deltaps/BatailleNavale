...
public class PartieEx{
  public static void main(String[] args){
    ...
    joueur1.placer(new Bateau(3),2,6,0);
    joueur1.placer(new Bateau(4),7,1,0);
    joueur1.placer(new Bateau(5),0,0,0);
    joueur1.placer(new Bateau(3),3,9,1);
    joueur1.placer(new Bateau(2),3,4,1);

    joueur2.placer(new Bateau(3),1,5,0);
    joueur2.placer(new Bateau(4),2,3,1);
    joueur2.placer(new Bateau(5),7,2,0);
    joueur2.placer(new Bateau(3),2,6,1);
    joueur2.placer(new Bateau(2),4,1,1);
